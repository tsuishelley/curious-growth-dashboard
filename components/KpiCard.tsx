...
interface KpiCardProps {
  ...
  /** Plain-language definition of the metric, surfaced on hover so labels like "Activation Rate" aren't ambiguous. */
  hint?: string;
}

export default function KpiCard({ label, value, changeFraction, changeLabel = "vs prior week", source, hint }: KpiCardProps) {
  ...
  return (
    <div className="border border-rule bg-paper p-5">
      ...
      <p className="label-mono min-h-[36px] text-ink-faint" title={hint}>
        {label}
        {hint && <span className="ml-1 cursor-help text-ink-faint/70">&#9432;</span>}
      </p>
